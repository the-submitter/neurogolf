...
NARRATION_WAV = WORK / "codexforge_voiceover_v2.wav"
SRT_PATH = (
    ROOT
    / "assets"
    / "video_processing"
    / "subtitles"
    / "codexforge_voiceover_v2.srt"
)
ASS_PATH = WORK / "codexforge_voiceover_v2.ass"
...
syn_config = SynthesisConfig(length_scale=1.08, volume=0.92)
        ...
        subprocess.run(
            [
                ...
                (
                    ...
                    f"afade=t=out:st={max(0.0, final_duration - 0.08):.4f}:d=0.08"
                ),
                "-ac",
                "1",
                str(final_path),
